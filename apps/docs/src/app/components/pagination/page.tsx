          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-70 dark:text-gray-30">
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong>로딩 상태:</strong> 페이지 변경 시 로딩 상태를
                  표시하여 사용자에게 피드백을 제공하세요
                </li>
                <li>
                ...
                <li>
                  <strong>총 항목 수 표시:</strong> 총 항목 수와 현재 범위를
                  함께 표시하면 사용자에게 더 많은 정보를 제공할 수 있습니다
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-70 dark:text-gray-30">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong>ARIA 속성:</strong> aria-current=&quot;page&quot;로
                  현재 페이지 표시
                </li>
                <li>
